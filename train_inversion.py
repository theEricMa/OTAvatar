...
if __name__ == '__main__':
    ...
    # create a model
    net_Warp, net_Warp_ema, opt_Warp, sch_Warp, net_G, net_G_ema, opt_G, sch_G \
        = gen_model_optimizer_4_warping_n_inversion(opt)

    trainer = get_trainer_4_warping_n_inversion(opt, net_Warp, net_Warp_ema, opt_Warp, sch_Warp, net_G, net_G_ema, opt_G, sch_G, train_dataset)
